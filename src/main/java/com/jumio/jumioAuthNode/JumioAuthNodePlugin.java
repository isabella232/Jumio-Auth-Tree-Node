...
public class JumioAuthNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(JumioAuthNodePlugin.currentVersion,
                                        Arrays.asList(JumioInitiateNode.class, JumioDecisionNode.class));
    }
    ...
    public void onInstall() throws PluginException {
        logger.info("Installing Jumio service");
        pluginTools.installService(JumioService.class);
        super.onInstall();
    }
    ...
    public void onStartup(StartupType startupType) throws PluginException {
        logger.info("Starting Jumio service");
        pluginTools.startService(JumioService.class);
    ...
    public String getPluginVersion() {
        return JumioAuthNodePlugin.currentVersion;
    }
}
